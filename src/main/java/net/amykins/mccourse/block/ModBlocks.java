package net.amykins.mccourse.block;

import net.amykins.mccourse.MCCourseMod;
import net.amykins.mccourse.block.custom.SpeedyBlock;
import net.amykins.mccourse.item.ModItemGroups;
...
public class ModBlocks {
    ...
    public static final Block DEEPSLATE_ORICHALCUM_ORE = registerBlock("deepslate_orichalcum_ore",
            new Block(FabricBlockSettings.of(Material.STONE).strength(7f).requiresTool()), ModItemGroups.COURSE);

    public static final Block RAW_ORICHALCUM_BLOCK = registerBlock("raw_orichalcum_block",
            new Block(FabricBlockSettings.of(Material.METAL).strength(5f).requiresTool()), ModItemGroups.COURSE);

    public static final Block SPEEDY_BLOCK = registerBlock("speedy_block",
            new SpeedyBlock(FabricBlockSettings.of(Material.WOOL).strength(2f).requiresTool()), ModItemGroups.COURSE);
